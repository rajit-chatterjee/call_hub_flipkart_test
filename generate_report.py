...
import os
import Common_Functions.file_test as ft
class MyTestSuite(unittest.TestCase):
  
    def test_Issue(self):
        direct = os.getcwd()
        iphone_test = unittest.TestSuite()
        iphone_test.addTests([unittest.defaultTestLoader.loadTestsFromTestCase(ft.test_iphone_flipkart)])
        outfile = open(direct + "\IPhoneTest.html", "w")
